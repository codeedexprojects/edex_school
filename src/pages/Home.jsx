...
function Home() {
  ...
  return (
    ...
    <div className="home-heading">
        <h1 >TRANSFORMING</h1>
        <h1>EDUCATION <span className='highlight'>INTO</span></h1>
        <h1>EXPERIENCE</h1>
      </div>
      <div className="sub">
        <h3>Learn.</h3>
...
<div class="card-container">
  ...
  <div className="home-banner">
    ...
    <h2>Next Batch Starts May 3!</h2><br />
    <h5>Admission Open</h5><br />
    <h5>Limited Seats Available!</h5><br />
    <h5>Location: Cherpulassery, Kerala</h5><br />
    <h5>Batch Start Date: May 3, 2025</h5><br />
    <button>Apply Now</button>
